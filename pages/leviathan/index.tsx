...
export default function Leviathan() {
  ...
  return (
    <Container maxWidth="sm">
        ...
        <Typography component="p" variant="h6" color="primary" align="center" sx={{ marginTop: "5%" }}>"His heart is as hot and hard as </Typography>
        ...
        <Typography component="p" variant="h6" color="primary" align="center">to become its master."</Typography>
