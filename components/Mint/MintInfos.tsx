...
const projectSentences = [
    ...
    <span key="sent-2">We are an innovative nft project on Boba Network. Our idea is similar to our brother Autoglyphs on Ethereum, except that we allow more fancy features on our NFTs, like the ability to collect and change the art displayed on your nft, ON CHAIN.</span>,
...
const cyberDaoSentences = [
    ...
    <span key="sent-15">Check out the <a style={{ color: goldColor }} href="https://cyberda0.medium.com/nox-city-today-news-dec-12-2077-olympians-ama-recap-580ece94c54e" target="_blank" rel="noreferrer">Olympians AMA</a> to know more about the partnership</span>
];
